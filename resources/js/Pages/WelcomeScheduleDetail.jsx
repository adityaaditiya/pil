...
export default function WelcomeScheduleDetail({ schedule, menuItems = [] }) {
    ...
    const scheduleRows = [
        ...
        { label: "Durasi Kelas", value: `${schedule.pilates_class?.duration || schedule.duration_minutes || 0} menit` },
        { label: "Perlengkapan Kelas", value: schedule.pilates_class?.equipment || "-" },
