        ...
        <>
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">Kelola data classes studio pilates.</p>
                </div>
                    ...
                    <Table.Tbody>
                        {classes.data.map((item) => (
                            <tr key={item.id}>
                                ...
                                <Table.Td>{new Date(item.scheduled_at).toLocaleString("id-ID")}</Table.Td>
                                ...
                                <Table.Td>{item.trainers}</Table.Td>
