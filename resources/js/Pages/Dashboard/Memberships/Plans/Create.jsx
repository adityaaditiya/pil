...
export default function Create({ classes }) {
    const { data, setData, post, processing, errors } = useForm({ name: "", credits: 1, price: 0, valid_days: "", activation_setting: "on_first_credit_use", is_active: true, description: "", tag: "", order_position: 0, class_rules: [] });
