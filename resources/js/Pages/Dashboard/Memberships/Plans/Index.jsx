    ...
    return (
        <>
            ...
            <Table.Card title="Data Paket Membership">
                <Table>
                    <Table.Thead><tr><Table.Th>Nama</Table.Th><Table.Th>Credits</Table.Th><Table.Th>Harga</Table.Th><Table.Th>Class Rules</Table.Th><Table.Th>Status</Table.Th><Table.Th></Table.Th></tr></Table.Thead>
                    <Table.Tbody>
                        {plans.data.map((plan) => (
                            <tr key={plan.id}>
