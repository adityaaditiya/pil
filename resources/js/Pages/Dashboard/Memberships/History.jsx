                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                {rows.length > 0 ? rows.map((membership, index) => (
                                    <tr key={membership.id} className="hover:bg-slate-50/70 dark:hover:bg-slate-800/40">
                                        ...
                                        <td className="px-4 py-4 text-sm text-slate-600 dark:text-slate-300">{membership.cashier_name || "-"}</td>
                                        ...
                                        <td className="px-4 py-4 text-center text-sm"><span className="inline-flex items-center gap-1 rounded-lg bg-primary-50 px-2.5 py-1 text-primary-700"><IconSparkles size={14} />{membership.credits_total || 0}</span></td>
                                ...
                                )) : <tr><td colSpan={11} className="px-4 py-10 text-center text-sm text-slate-500 dark:text-slate-400">Belum ada data riwayat membership.</td></tr>}
                            </tbody>
                        </table>
                    </div>
                </div>
