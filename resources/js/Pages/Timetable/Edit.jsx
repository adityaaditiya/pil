                ...
                <form onSubmit={submit} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
                    <div className="grid gap-8 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
                        <div className="grid gap-5 md:grid-cols-2">
                            ...
                            <div className="space-y-2"><label className="text-sm font-semibold">Durasi (Menit)</label><select disabled={isLocked} value={data.duration_minutes} onChange={(e) => setData("duration_minutes", e.target.value)} className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm">{[30, 60, 75, 90, 120, 150, 180].map((v) => <option key={v} value={v}>{v} Menit</option>)}</select></div>
