                ...
                <form onSubmit={submit} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
                    <div className="grid gap-8 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
                        <div className="grid gap-5 md:grid-cols-2">
                            ...
                            <div className="space-y-2 md:col-span-2"><label className="text-sm font-semibold">Keterangan</label><textarea disabled={isLocked} value={data.admin_notes} onChange={(e) => setData("admin_notes", e.target.value)} rows={3} className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm" /></div>
