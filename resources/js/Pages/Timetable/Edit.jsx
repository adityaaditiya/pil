...
export default function Edit({ classes = [], trainers = [], session }) {
                ...
                <div className="flex items-center justify-between gap-3">
                    <div>
                        ...
                        <h1 className="flex items-center gap-2 text-2xl font-bold text-slate-900 dark:text-white">
                            <IconCalendarPlus size={26} className="text-primary-500" /> Ubah Session
                        </h1>
                        <p className="mt-1 text-sm text-slate-500">Perbarui jadwal session pilates untuk booking pelanggan.</p>
                    </div>
                </div>
